          ...
          {isSuccess ? (
            <CardContent className="p-8 text-center space-y-4">
              ...
              <div className="space-y-1.5">
                <h3 className="font-extrabold text-slate-900 text-base">Password Changed!</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
                  Your password has been successfully updated. You can now sign in to your portal.
                </p>
              </div>
            ...
            <form onSubmit={handleSubmit}>
              <CardHeader className="pt-6 pb-2 border-b border-slate-100">
                <CardTitle className="text-slate-900 text-base font-bold">New Credentials</CardTitle>
